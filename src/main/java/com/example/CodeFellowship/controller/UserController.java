...
import com.example.CodeFellowship.config.UserDetailsServiceImpl;
...
public class UserController {
    ...
    @PostMapping("/signup")
    public RedirectView createUser(String username, String password, String firstName, String lastName,LocalDate dateOfBirth,String bio,String image){
    ...
    public  String editProfile(Principal p, Model m){
        ...
        return "editProfilePage.html";
    }
    @PutMapping("/updateProfile")
    public RedirectView editProfile(Principal p,String username, String firstName, String lastName, LocalDate dateOfBirth, String bio, String image , RedirectAttributes redirectAttributes){
        if ((p != null) && (p.getName().equals(username))) {
            ...
            redirectAttributes.addFlashAttribute("errorMessage","Can't Edit User Profile Page !!!");
        }
    ...
    public String searchUsers(@RequestParam(name = "q") String query, Model model) {
        List<ApplicationUser> searchResults = (List<ApplicationUser>) userRepository.findByUsername(query);
